...
class ResultManagementSystem:
    def __init__(self,home):
        ...
        #Title of project
        title=Label(self.home,text="Online Exam Result Search",padx=10,compound=LEFT,image=self.logo,font=("times new roman",20,"bold"),bg="Navy Blue",fg="white").place(x=0,y=0,relwidth=1,height=50)
        ...
        #Footer
        footer=Label(self.home,text="Contact Me: \n  gawaresakshi252@gmail.com",font=("times new roman",13,"bold"),bg="grey",fg="white").pack(side=BOTTOM,fill=X)
